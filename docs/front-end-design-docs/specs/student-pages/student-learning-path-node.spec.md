...
---
# Vocabulary unit — page spec
> Paste with _DESIGN-SYSTEM.md. If absent, stop; do not invent tokens.
## 1 Purpose
Study, practice and persist completion of a real vocabulary unit.
## 2 Access
Student only; server-owned progress and prerequisite enforcement.
## 3 API mapping
GET /student/learning-path/:slug; POST /:slug/start, /study, /answers, /complete. All use data detail.
Errors from module 05-learning-path; mutations require revision and exact DTO fields.
## 4 Structure
Back link, heading, stage indicator, study card, single quiz question, feedback and next.
## 5 Components
