...
- 🔶 (codex · 2026-09-05) F7.1 Browse & view vocabulary cards · F7.2 Add card to review deck
- 🔶 (codex · 2026-09-05) F7.3 SRS review session (SM-2 algorithm — full formula in PROJECT_KNOWLEDGE.md 4.3)
- 🔶 (codex · 2026-09-05) F7.4 Review stats (streak, cards learned)
- 🔶 (codex · 2026-09-05) F6.1 Weekly skill heatmap · F6.2 Progress chart
...
- 🔶 (codex · 2026-09-05) Content loader: read + validate the JSON files, schema guards
- 🔶 (codex · 2026-09-05) F9 Pronunciation foundation (pinyin table, tones, tone sandhi, 214 radicals, 4 PDFs)
- 🔶 (codex · 2026-09-05) F10 Grammar points (browse, auto-generate exercises from `tokens`, progress)
- 🔶 (codex · 2026-09-05) F11 Character writing (stroke-order animation, canvas practice, radical breakdown)
- 🔶 (codex · 2026-09-05) F12 Lego sentence builder (7 stations, drag-drop with S/T/P/A/V/O/C/Q roles, endless mode)
- 🔶 (codex · 2026-09-05) F13 HSK mock exams (11 exams / 161 questions, real timers, skill breakdown → `SkillScore`)
- 🔶 (codex · 2026-09-05) F14 Workplace roleplay (6 scenarios, multi-turn, keyword scoring)
- 🔶 (codex · 2026-09-05) F15 Learning path (2 curricula, topic map, side quests, 3 bosses)
- 🔶 (codex · 2026-09-05) F16 Gamification (XP, 9 named levels, 6 imperial-exam ranks, streaks, 20 badges, leaderboard)
- 🔶 (codex · 2026-09-05) Contract-first entity/module design for catalog, personal progress, supplemental practice
