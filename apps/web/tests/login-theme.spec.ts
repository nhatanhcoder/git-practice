 ...
 *
 * The auth shell styled text through --fg/--fg-muted tokens that tokens.css
 * never defines — the title inherited the browser default and washed out on
 * the dark ground, and the shell hardcoded dark so a saved light preference
 * never reached it. These tests pin the fix from both directions:
