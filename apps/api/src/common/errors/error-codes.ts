...
export const ErrorCode = {
  ...
  LEGO_STATION_NOT_FOUND: 'LEGO_STATION_NOT_FOUND',
  WORKPLACE_SCENARIO_NOT_FOUND: 'WORKPLACE_SCENARIO_NOT_FOUND',
  WORKPLACE_TURN_NOT_FOUND: 'WORKPLACE_TURN_NOT_FOUND',
  ...
  LEARNING_PATH_FROZEN: 'LEARNING_PATH_FROZEN',
  LEARNING_PATH_EMPTY: 'LEARNING_PATH_EMPTY',
  LEARNING_PATH_REJECTION_REASON_REQUIRED: 'LEARNING_PATH_REJECTION_REASON_REQUIRED',
  LEARNING_PATH_HAS_PUBLISHED_UNITS: 'LEARNING_PATH_HAS_PUBLISHED_UNITS',
  LEARNING_UNIT_PUBLISHED_IMMUTABLE: 'LEARNING_UNIT_PUBLISHED_IMMUTABLE',
  LEARNING_UNIT_ORDER_INVALID: 'LEARNING_UNIT_ORDER_INVALID',
  LEARNING_UNIT_NOT_OWNED: 'LEARNING_UNIT_NOT_OWNED',
  LEARNING_UNIT_REFERENCE_INVALID: 'LEARNING_UNIT_REFERENCE_INVALID',
  ...
  // Lesson supplements (registry § Supplement Errors) — API-020, agreed 2026-09-26.
  SUPPLEMENT_ALREADY_ATTACHED: 'SUPPLEMENT_ALREADY_ATTACHED',
  SUPPLEMENT_NOT_ATTACHED: 'SUPPLEMENT_NOT_ATTACHED',
  SUPPLEMENT_ORDER_CONFLICT: 'SUPPLEMENT_ORDER_CONFLICT',
  SUPPLEMENT_SOURCE_NOT_FOUND: 'SUPPLEMENT_SOURCE_NOT_FOUND',
...
export const ERROR_STATUS: Record<ErrorCodeValue, number> = {
  ...
  LEGO_STATION_NOT_FOUND: 404,
  WORKPLACE_SCENARIO_NOT_FOUND: 404,
  WORKPLACE_TURN_NOT_FOUND: 404,
  ...
  LEARNING_PATH_ACCESS_DENIED: 403,
  LEARNING_PATH_INVALID_STATUS: 409,
  LEARNING_PATH_FROZEN: 409,
  LEARNING_PATH_EMPTY: 409,
  LEARNING_PATH_REJECTION_REASON_REQUIRED: 400,
  LEARNING_PATH_HAS_PUBLISHED_UNITS: 409,
  LEARNING_UNIT_PUBLISHED_IMMUTABLE: 409,
  LEARNING_UNIT_ORDER_INVALID: 400,
  LEARNING_UNIT_NOT_OWNED: 403,
  LEARNING_UNIT_REFERENCE_INVALID: 409,
  ...
  SUPPLEMENT_ALREADY_ATTACHED: 409,
  SUPPLEMENT_NOT_ATTACHED: 404,
  SUPPLEMENT_ORDER_CONFLICT: 409,
  SUPPLEMENT_SOURCE_NOT_FOUND: 404,
